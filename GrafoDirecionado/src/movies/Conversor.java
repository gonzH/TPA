...
public class Conversor {
    ...
    public Conversor(String nome_arq){
        this.dicElements = new TADDicChain(null);
        this.dicRelationships = new TADDicChain(null);
    ...
    public void converte(String nomearq, String output) throws FileNotFoundException, IOException {
        BufferedReader br = new BufferedReader(new FileReader(this.pathArq + nomearq));
        String line = "";
...
//                        System.out.println("BEFORE: "+dicRelationships.findElement(filme));
        ...
        BufferedWriter bw = new BufferedWriter(new FileWriter(this.pathArq + output, true));
